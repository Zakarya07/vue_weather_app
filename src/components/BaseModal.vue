<template>
    <Teleport to="body">
        <Transition name="modal-outer">
            <!-- Modal container -->
            <div v-show="modal_active" class="absolute w-full bg-black bg-opacity-30 h-screen top-0 left-0 flex justify-center px-8">
                <!-- Modal content -->
              <Transition name="modal-inner">
                <div v-if="modal_active" class="p-4 bg-white self-start mt-32 max-w-screen-md">
                    <slot />
