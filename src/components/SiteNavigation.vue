<template>
  <header class="sticky top-0 bg-weather-primary shadow-lg">
    ...
    >
      ...
      <!-- Modal component -->
      <BaseModal :modal_active="modal_active" @close-modal="toggleModal" >
        <!-- Content of the modal (using slot) -->
...
const addCity = () => {
  ...
  saved_cities.value.push(location_obj);
  localStorage.setItem('saved_cities', JSON.stringify(saved_cities.value));

  let query = Object.assign( {}, route.query);
  delete query.preview;
  query.id = location_obj.id;
